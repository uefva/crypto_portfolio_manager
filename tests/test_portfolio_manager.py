...
class PortfolioManagerTest(unittest.TestCase):
    ...
    def test_legacy_crypto_data_is_migrated_to_v2(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(manager.data[asset_id]["total_cost_cny"], 210000)
    ...
    def test_buy_sell_tracks_native_and_cny_cost_basis(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(asset["total_cost_cny"], 70)
            self.assertEqual(asset["transactions"][1]["total_cny"], 86.4)
            ...
            self.assertAlmostEqual(snapshot["total_profit"], 8.1)
