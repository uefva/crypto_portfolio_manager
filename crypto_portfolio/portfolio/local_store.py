"""Local JSON-backed portfolio store and calculation compatibility layer.

The local store remains the offline fallback for the desktop client. Orders are
stored in native asset currency; CNY values are derived when prices are queried.
"""
