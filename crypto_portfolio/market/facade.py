"""Market data facade combining quotes, search, and FX helpers.

This module currently carries the original market implementation while the
smaller market modules below provide domain-oriented import paths.
"""
